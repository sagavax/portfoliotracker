                    ...
                    //list of transactions
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<div class='transaction'>";
                                echo "<button type='button' class='button' name='ticker'>$transaction_ticker</button>";
                                echo "<button type='button' class='button' name='provider'>$transaction_provider</button>";
                                echo "<button type='button' class='button' name='category'>$transaction_category</button>";
                                echo "<button type='button' class='button' name='currency'>$transaction_currency</button>";
                                echo "<div class='quasntity'>$transaction_quantity</div>";
                                echo "<div class='price'>$transaction_entry_price</div>";
                                $tp_display = ($transaction_tp == 0.0) ? "TP" : $transaction_tp;
                                $sl_display = ($transaction_sl == 0.0) ? "SL" : $transaction_sl;
                                echo "<div class='tp'>".$tp_display." / ".$sl_display."</div>";
                                $ls_class = ($transaction_long_short === "BUY") ? "long" : (($transaction_long_short === "SELL") ? "short" : "");
                                echo "<button type='button' class='button ".$ls_class."' name='long_short'>".$transaction_long_short."</button>";
                                echo "<button type='button' class='button' name='add_note'><i class='fa fa-plus'></i> Add note</button>";
                                echo "<button type='button' class='button' name='delete_transaction' data-id='$transaction_id'><i class='fa fa-times'></i></button>";
                            echo "</div>";
                        }

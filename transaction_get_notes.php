<?php
    ...
    echo "<div class='notes_header_wrapper'><button type='button' class='transaction_button' name='add_note'><i class='fa fa-plus'></i> Add note</button><button type='button' class='transaction_button' name='close_notes'><i class='fa fa-times'></i></button></div>";

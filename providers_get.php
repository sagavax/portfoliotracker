<?php
    ...
    while ($row = mysqli_fetch_array($result)) {
     ...
     echo '<input name="new_provider_name" id="new_provider_name" type="text" placeholder="New provider name"><div class="provider_card" data-name="new_provider"><i class="fa fa-plus"></i> New provider</div>';
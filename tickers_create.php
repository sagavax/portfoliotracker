...
$company_name = mysqli_real_escape_string($link, $_POST['company_name']) ?? trim($_POST['company_name']);
...
$create_ticker = "INSERT INTO tickers (ticker, short_name, company_name, industry, website) VALUES ('$new_ticker', '$short_name', '$company_name', '$industry', '$website')";
